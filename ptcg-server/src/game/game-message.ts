...
export enum GameStoreMessage {
  ...
  CANNOT_ATTACK_FIRST_TURN = 'CANNOT_ATTACK_FIRST_TURN',
  CANNOT_SUPPORTER_FIRST_TURN = 'CANNOT_SUPPORTER_FIRST_TURN',
  CHOOSE_NEW_TYPE = 'CHOOSE_NEW_TYPE',
  CHOOSE_NEW_WEAKNESS = 'CHOOSE_NEW_WEAKNESS',
  CHOOSE_NEW_RESISTANCE = 'CHOOSE_NEW_RESISTANCE',
  CHOOSE_NEW_ACTIVE_POKEMON = 'CHOOSE_NEW_ACTIVE_POKEMON',
  CHOOSE_PRIZE_CARD = 'CHOOSE_PRIZE_CARD',
  CHOOSE_STARTING_POKEMON = 'CHOOSE_STARTING_POKEMON',
  LOOK_AT_WHICH_DECK = 'LOOK_AT_WHICH_DECK',
  ...
  VSTAR_POWER_ALREADY_USED = 'VSTAR_POWER_ALREADY_USED',
...
export enum GameCardMessage {
  ...
  CHOOSE_CARD_TO_LOST_ZONE = 'CHOOSE_CARD_TO_LOST_ZONE',
  CHOOSE_CARD_TO_HAND = 'CHOOSE_CARD_TO_HAND',
  CHOOSE_TOOL_TO_HAND = 'CHOOSE_TOOL_TO_HAND',
  CHOOSE_ITEM_TO_HAND = 'CHOOSE_ITEM_TO_HAND',
  ...
  CHOOSE_POKEMON_TO_DECK = 'CHOOSE_POKEMON_TO_DECK',
  CHOOSE_SPECIAL_CONDITION = 'CHOOSE_SPECIAL_CONDITION',
  COIN_FLIP = 'COIN_FLIP',
  LABEL_COLORLESS = 'LABEL_COLORLESS',
  LABEL_DARKNESS = 'LABEL_DARKNESS',
  LABEL_DRAGON = 'LABEL_DRAGON',
  LABEL_FAIRY = 'LABEL_FAIRY',
  LABEL_FIGHTING = 'LABEL_FIGHTING',
  LABEL_FIRE = 'LABEL_FIRE',
  LABEL_GRASS = 'LABEL_GRASS',
  LABEL_LIGHTNING = 'LABEL_LIGHTNING',
  LABEL_METAL = 'LABEL_METAL',
  LABEL_PSYCHIC = 'LABEL_PSYCHIC',
  ...
  WANT_TO_EVOLVE_AGAIN = 'WANT_TO_EVOLVE_AGAIN',
...
export enum GameLog {
  ...
  LOG_PLAYER_DISCARDS = 'LOG_PLAYER_DISCARDS', // { name, card }
  ...
  LOG_PLAYER_USES_STADIUM = 'LOG_PLAYER_USES_STADIUM', // { name, stadium }
  LOG_POKEMON_TAKES_DAMAGE = 'LOG_POKEMON_TAKES_DAMAGE', // { name, damage }
