...
export class PokemonBreeder extends TrainerCard {
  ...
  public text: string =
    'Put a Stage 2 Evolution card from your hand on the matching Basic Pokémon. ' +
    'You can only play this card when you would be allowed to evolve that Pokémon anyway.';
