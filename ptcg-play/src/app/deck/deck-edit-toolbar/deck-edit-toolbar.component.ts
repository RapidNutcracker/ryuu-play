...
export class DeckEditToolbarComponent {
  ...
  public sets = [
    ...
    { value: 'RO', label: 'LABEL_TEAM_ROCKET' },
    { value: 'G1', label: 'LABEL_GYM_HEROES' },
    { value: 'G2', label: 'LABEL_GYM_CHALLENGE' },
    { value: 'N1', label: 'LABEL_NEO_GENESIS' },
    { value: 'N2', label: 'LABEL_NEO_DISCOVERY' },
    { value: 'N3', label: 'LABEL_NEO_REVELATION' },
    { value: 'N4', label: 'LABEL_NEO_DESTINY' },
    { value: 'EX', label: 'LABEL_EXPEDITION' },
    { value: 'AQ', label: 'LABEL_AQUAPOLIS' },
    { value: 'SK', label: 'LABEL_SKYRIDGE' },
